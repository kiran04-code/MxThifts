    ...
    return (
       ...
       <div className='md:flex md:justify-center md:items-center md:gap-6 flex  items-center gap-5'>
             <Image
                ...
                src="/black_logo.png"
                alt="Logo"
                className="md:w-50 md:h-50 h-15 w-15 object-contain"
            />
            <h1 className="text-4xl lg:text-[200px] font-semibold text-transparent bg-clip-text bg-gradient-to-b from-gray-100 to-black">
                Maxx Thrift's
            </h1>
       </div>
