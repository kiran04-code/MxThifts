    ...
    return (
        <div className='md:flex md:justify-between '>
            <div className='w-full md:w-[800px] md:p-20 p-5 flex flex-col gap-5'>
                <h1 className='text-4xl sm:text-5xl md:text-[80px] font-bold leading-snug md:leading-[1.1]'>
                    Thrifted Finds.{' '}
            ...
            <div className='retaive  justify-end  items-center flex'>
                <div className='absoulte '>
                    <video src="kiran01.mp4 " className=' border-2 rounded-2xl shadow-lg' loop autoPlay muted></video>
                </div>
