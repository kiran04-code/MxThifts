  ...
  return (
    <div>
      ...
      <div className="p-5 ">
        ...
        <div className="bg-white shadow-md rounded-xl p-6">
          {
            adress ? <div><h2 className="text-xl font-semibold text-gray-700 mb-4">Saved Address</h2>
          <p><span className="font-medium">Home:</span> 123, Green Street, Pune, India</p>
          <p><span className="font-medium">Office:</span> 45, Tech Park, Hinjewadi, Pune</p></div>:<button onClick={()=>setAdress(!adress)}   className="p-2 rounded-xl bg-black text-white">Add Address</button>
          }
        </div>
